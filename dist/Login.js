...
export var Login = function (_a) {
    var showModal = _a.showModal, setShowModal = _a.setShowModal, _b = _a.backdropDismiss, backdropDismiss = _b === void 0 ? false : _b, profileFunction = _a.profileFunction, providers = _a.providers, onSignIn = _a.onSignIn, onSignOut = _a.onSignOut, SUPABASE_URL = _a.SUPABASE_URL, SUPABASE_KEY = _a.SUPABASE_KEY;
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(IonModal, __assign({ isOpen: showModal, backdropDismiss: backdropDismiss, className: 'my-custom-class' }, { children: [_jsxs(IonHeader, { children: [_jsxs(IonToolbar, { children: [_jsx(IonButtons, __assign({ slot: "start" }, { children: _jsx(IonButton, __assign({ color: 'primary', onClick: function () { return setShowModal ? setShowModal(false) : null; } }, { children: _jsx(IonIcon, { size: 'large', icon: closeOutline }) })) })), _jsx(IonTitle, { children: "Sign In" })] }), _jsx(IonButtons, { slot: "start" })] }), _jsxs(IonContent, { children: [_jsx(IonLoading, { isOpen: showLoading, message: 'Loading' }), _jsxs(IonGrid, __assign({ class: "ion-padding", style: { maxWidth: '375px' } }, { children: [_jsx(IonRow, { children: _jsx(IonCol, { children: _jsx(IonLabel, { children: "Email Address" }) }) }), _jsx(IonRow, { children: _jsx(IonCol, { children: _jsx(IonItem, __assign({ className: "loginItem", lines: "none" }, { children: _jsx(IonInput, __assign({ type: "email", placeholder: "Email", onIonChange: function (e) { return setEmail(e.detail.value); }, value: email, className: "loginInputBoxWithIcon" }, { children: _jsx(IonIcon, { className: "inputIcon", icon: mailOutline, slot: "start", size: "large", color: "medium" }) })) })) }) }), !validateEmail(email) && email.length > 0 &&
